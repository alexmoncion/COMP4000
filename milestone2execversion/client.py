...
ip = 'localhost:50051' #sams ip 192.168.46.27:10001 #localhost is [::]:50051
...
class Passthrough(Operations):
    ...
    def read(self, path, length, offset, fh):
        ...
        response = stub.RunTerminalCommand3(account_pb2.HelloRequest(fh=request[0], offset=request[1], length=request[2]))
        return response.message2
