...
class ReplyStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AdminUpdate = channel.unary_unary(
                '/Reply/AdminUpdate',
                request_serializer=account__pb2.AdminUpdateRequest.SerializeToString,
                response_deserializer=account__pb2.UpdateReply.FromString,
                )
        self.CreationTolerance = channel.unary_unary(
                '/Reply/CreationTolerance',
                request_serializer=account__pb2.CreationToleranceRequest.SerializeToString,
                response_deserializer=account__pb2.CreationToleranceReply.FromString,
                )
...
def add_ReplyServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AdminUpdate': grpc.unary_unary_rpc_method_handler(
                    servicer.AdminUpdate,
                    request_deserializer=account__pb2.AdminUpdateRequest.FromString,
                    response_serializer=account__pb2.UpdateReply.SerializeToString,
            ),
            'CreationTolerance': grpc.unary_unary_rpc_method_handler(
                    servicer.CreationTolerance,
                    request_deserializer=account__pb2.CreationToleranceRequest.FromString,
                    response_serializer=account__pb2.CreationToleranceReply.SerializeToString,
            ),
    }
...
class Reply(object):
    ...
    def AdminUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Reply/AdminUpdate',
            account__pb2.AdminUpdateRequest.SerializeToString,
            account__pb2.UpdateReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def CreationTolerance(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Reply/CreationTolerance',
            account__pb2.CreationToleranceRequest.SerializeToString,
            account__pb2.CreationToleranceReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
